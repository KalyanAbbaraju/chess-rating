      ...
      <div className="space-y-8 text-gray-700">
        ...
        <section>
          ...
          <p className="mb-4 leading-relaxed">
            At Chess Companion, we respect your privacy and are committed to protecting your personal data. 
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4 text-gray-800">The Data We Collect</h2>
          <p className="mb-4 leading-relaxed">
            Chess Companion is designed to minimize data collection. We collect and process the following data:
          </p>
