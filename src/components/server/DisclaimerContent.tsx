...
const DisclaimerContent: React.FC<DisclaimerContentProps> = ({ organization }) => {
  ...
  let content = {
    shortText: "This is an estimate only; actual calculations may vary slightly.",
    title: "Rating Calculation Disclaimer",
    details: <></>
  };
  
  if (organization === 'FIDE') {
    content = {
    ...
    content = {
      ...
      details: (
        <>
          <p className="mb-3">
            The rating calculations provided by this tool are based on the published English Chess Federation 
            rating formulas and are intended to be used for estimation purposes only.
          </p>
          
          <p className="mb-3">
            Actual official ECF ratings may differ due to several factors:
          </p>
          
          <ul className="list-disc pl-5 mb-3 space-y-1">
            <li>Special rating adjustments applied by the ECF</li>
            <li>Rounding differences in calculation methods</li>
            <li>Tournament-specific rules or exceptions</li>
            <li>Recent changes to the rating formula not yet reflected in this tool</li>
            <li>K-factor differences for different player categories</li>
            <li>Established vs. new player rating calculations</li>
          </ul>
          
          <p className="mb-3">
            <strong>Important note:</strong> ECF ratings are calculated after each graded event, and this estimator 
            may not perfectly match the official ECF calculation method for all scenarios.
          </p>
          
          <p className="mb-3">
            For official ratings, always refer to the English Chess Federation&apos;s official website and publications. 
            This tool does not replace official ratings issued by the ECF.
          </p>
          
          <p>
            The developers of this tool make no guarantees about the accuracy of these estimates 
            and are not affiliated with or endorsed by the English Chess Federation.
          </p>
        </>
      )
    };
